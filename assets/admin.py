...
class NewAssetAdmin(admin.ModelAdmin):
    ...
    actions = ['approve_seletcd_new_assets']

    def approve_seletcd_new_assets(self,request,queryset):
        seletced = request.POST.getlist(admin.ACTION_CHECKBOX_NAME)
        success_upline_number = 0
        for asset_id in seletced:
    ...
    approve_seletcd_new_assets.short_description = "批准选择的新资产"
